def get_basic_operations_explanation():
...
def get_inverse_explanation():
    ...
    explanation_inverse_block_3="""Az inverz mátrix meghatározásának egyik módszere, amit ez az alkalmazás is használ, a Gauss-elimináció, amely során a mátrixot és egy vele egy méretű egységmátrixot együtt alakítunk át. A Gauss-elimináció segítségével az eredeti mátrixot fokozatosan egységmátrixxá formáljuk, miközben a mellette lévő egységmátrix átalakul és az A mátrix inverzévé válik."""
    return [explanation_inverse_block_1,explanation_inverse_block_2,explanation_inverse_block_3]

def get_determinant_explanation():
...
def get_explanation_Cholesky():
    explanation_Cholesky_block_1="""\nA Cholesky-dekompozíció egy speciális típusa az LU faktorizációnak, amelyet szimmetrikus és pozitív definit mátrixok felbontására használnak. \n\nEz a módszer egy adott A mátrixot egy alsó háromszögű L mátrix és annak transzponáltjának szorzatára bontja:"""
    explanation_Cholesky_block_2="""A Cholesky-dekompozíció előnye, hogy gyorsabb és stabilabb, mint az általános LU dekompozíció, viszont csak szimmetrikus, pozitív definit mátrixok esetén alkalmazható. """
    explanation_Cholesky_block_3="""\nA Cholesky-dekompozíció csak fele annyi műveletet igényel, mint az általános LU dekompozíció, mivel a szimmetria miatt csak az L mátrixot kell kiszámítani. """
